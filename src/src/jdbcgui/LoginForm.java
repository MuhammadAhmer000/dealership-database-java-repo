...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Login to Dealership Application");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            System.out.println(md5(txtPassword.getText()));
            rs = dbCon.executeStatement("SELECT username, password, name, type FROM loginusers WHERE username = '" + txtUsername.getText().trim() + "' AND password = '" + md5(txtPassword.getText().trim()) + "'");
            if (rs.next()) { // loop over the current login user accounts searching for a match 
                    validLogin = true;
                    ...
                    menu.setVisible(true);                    this.dispose(); // remove this login from from memory 
            }
